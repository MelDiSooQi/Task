    ...
    angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function(e, n) {
        ...
        return {
            ...
            store: function(t, r, o) {
                ...
                if (e.plugins) {
                    var u;
                    u = 3 === arguments.length ? e.plugins.appPreferences.store(o, t, r) : e.plugins.appPreferences.store(t, r), u.then(i, a)
            ...
            fetch: function(t, r) {
                ...
                if (e.plugins) {
                    var s;
                    s = 2 === arguments.length ? e.plugins.appPreferences.fetch(r, t) : e.plugins.appPreferences.fetch(t), s.then(o, i)
            ...
            remove: function(t, r) {
                ...
                if (e.plugins) {
                    var s;
                    s = 2 === arguments.length ? e.plugins.appPreferences.remove(r, t) : e.plugins.appPreferences.remove(t), s.then(o, i)
                } else a.reject(new Error(this.pluginNotEnabledMessage));
                return this.decoratePromise(c), c
            },
            show: function() {
                ...
                var o = n.defer(),
                    i = o.promise;
                return e.plugins ? e.plugins.appPreferences.show().then(t, r) : o.reject(new Error(this.pluginNotEnabledMessage)), this.decoratePromise(i), i
            }
        }
        ...
        return {
            openDB: function(e, t) {
                return angular.isObject(e) && !angular.isString(e) ? ("undefined" != typeof t && (e.bgType = t), n.sqlitePlugin.openDatabase(e)) : n.sqlitePlugin.openDatabase({
                    name: e,
                    bgType: t
                })
            },
        ...
        return {
                    ...
                    if (t.isInAppBrowserInstalled(c) === !0) {
                        ...
                        s.addEventListener("loadstart", function(e) {
                            if (0 === e.url.indexOf("http://localhost/callback")) {
                                ...
                                console.log(t), n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                                    method: "post",
                ...
                if (window.cordova) {
                    ...
                    if (t.isInAppBrowserInstalled(u) === !0) {
                        ...
                        d.addEventListener("loadstart", function(e) {
                            0 === e.url.indexOf(l) && (requestToken = e.url.split("code=")[1].split("&")[0], n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                                method: "post",
            ...
            slack: function(r, o, i, a) {
                ...
                if (window.cordova) {
                    ...
                    if (t.isInAppBrowserInstalled(s) === !0) {
                        ...
                        l.addEventListener("loadstart", function(e) {
                            0 === e.url.indexOf(u) && (requestToken = e.url.split("code=")[1], console.log("Request token is " + requestToken), n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                                method: "post",
            ...
            twitter: function(r, o, i) {
                ...
                if (window.cordova) {
                    ...
                    if (true) {
                        //var s = "http://localhost/callback";
                    	var s = "http://gonapps.com/test/instagramAuthCallBack.html";
            ...
            weibo: function(r, o, i, a) {
                ...
                if (window.cordova) {
                    ...
                    if (t.isInAppBrowserInstalled(s) === !0) {
                        ...
                        void 0 !== a && (a.hasOwnProperty("language") && (l += "&language=" + a.language), a.hasOwnProperty("forcelogin") && (l += "&forcelogin=" + a.forcelogin));
            ...
            dribble: function(r, o, i, a, c) {
                ...
                if (window.cordova) {
                    ...
                    if (t.isInAppBrowserInstalled(u) === !0) {
                        var l = "http://localhost/callback",
                            d = "https://dribbble.com/oauth/authorize",
                            f = "https://dribbble.com/oauth/token";
                        void 0 !== a && a.hasOwnProperty("redirect_uri") && (l = a.redirect_uri), void 0 === c && (c = t.createNonce(5));
                        var p = i.join(",").replace(/,/g, "+"),
                            v = window.open(d + "?client_id=" + r + "&redirect_uri=" + l + "&scope=" + p + "&state=" + c, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
